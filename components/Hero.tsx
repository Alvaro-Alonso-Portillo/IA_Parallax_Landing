      ...
      <div className="max-w-[1440px] mx-auto text-center relative z-30">
        ...
        <div className="flex flex-col items-center gap-2 md:gap-4 relative">
          ...
          <div className="relative z-10">
            ...
            <img src="https://cdn.prod.website-files.com/67cac54830ea1e856c034bd3/67d85869983afc658b8861ea_pepe%20(1).png" className="absolute -left-16 md:-left-32 top-1/2 -translate-y-1/2 w-20 md:w-40 animate-float drop-shadow-sketch -scale-x-100 -z-10 pointer-events-none" alt="Pepe" />
          </div>
        </div>
        ...
        <div className="mt-8 md:mt-12 flex justify-center gap-4 md:gap-6 relative z-30 flex-col md:flex-row items-center px-4 md:px-0">
          <a href="#contact" className="w-full md:w-auto bg-black text-white px-8 py-4 text-lg md:text-xl font-display uppercase tracking-wider hover:bg-brand-blue transition-all flex items-center justify-center gap-4 group border-2 border-black rounded-full shadow-sketch hover:shadow-sketch-lg hover:-translate-y-1">
