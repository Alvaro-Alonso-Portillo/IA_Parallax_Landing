    ...
    <section id="about-us" className="py-24 bg-white relative overflow-hidden">
      <div className="max-w-[1440px] mx-auto px-4 md:px-8 relative z-10">
        ...
        <div className="relative max-w-4xl mx-auto flex flex-col gap-12 md:gap-24">
          ...
          {/* Thread Line - Central dashed line */}
          ...
          {/* Item 1: Bubble Left, Character Right (Hanging) */}
          <div className="flex flex-col md:flex-row items-center gap-8 relative">
            ...
            <div className="md:w-1/2 relative">
              ...
              <div className="relative w-48 h-48 mx-auto animate-float">
                <div className="absolute top-0 left-1/2 -translate-x-1/2 w-1 h-32 bg-black"></div>
                <img src="https://cdn.prod.website-files.com/67cac54830ea1e856c034bd3/67d8589fe8dc80cbd5e9e377_Group%201413376294%20(1).svg" className="w-full h-full object-contain relative z-10 top-12" alt="Hanging Character" />
              </div>
            </div>
          </div>

          {/* Item 2: Character Left, Bubble Right */}
          <div className="flex flex-col md:flex-row-reverse items-center gap-8 relative">
            ...
            <div className="md:w-1/2 flex justify-center">
              <div className="w-40 h-40 border-2 border-black rounded-full overflow-hidden shadow-sketch bg-brand-blue/20">
          ...
          <div className="flex flex-col md:flex-row items-center gap-8 relative">
            ...
            <div className="md:w-1/2 flex justify-center">
              <div className="w-48 h-64 border-2 border-black bg-white p-2 shadow-sketch transform rotate-2">
                ...
                <div className="text-center mt-2 font-display text-sm">THE BOSS</div>
              </div>
            </div>
          </div>
